...
//       <Link to="/createarchitect"><FontAwesomeIcon icon={faUser} className="icon" /></Link>
//       </div>
//     </header>
//   );
// }
...
const Navbar = () => {
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", width: "100vw" }}>
      ...
      <div>
        <div className="navbar-fixed" style={{ display: "flex", justifyContent: "center", flexDirection: "column", height: "" }}>
          ...
          <div >
            ...
            <div className={`navbar-items ${isMobileMenuOpen ? "mobilemenu" : ""}`}>
              ...
              {localStorage.getItem("authToken") ?
                ...
                <>
                  ...
                  <div className='navtext' onClick={closeMobileMenu}>
                    <Link style={{ textDecoration: "none", color: "black" }} to='/signup'>SignIn</Link>
                  </div>
                </>
              }
            </div>
            ...
            {localStorage.getItem('authToken') &&
              <div >
                ...
                <Badge className='badge' pill bg="dark">{items.length}</Badge>
              </div>
            }
            </div>
          </div>
