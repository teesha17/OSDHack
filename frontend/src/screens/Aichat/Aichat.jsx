    ...
    <>
      <div className="bg-white h-screen p-3">
        ...
        >
          ...
          <button
            type="submit"
            className="bg-blue-300 p-3 rounded-md hover:bg-blue-400 text-white transition-all duration-300"
            disabled={generatingAnswer}
          >
            Generate answer
          </button>
        </form>
        <div className="w-full md:w-2/3 m-auto text-center rounded bg-gray-50 my-1 text-white">
